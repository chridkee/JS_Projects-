...
const smoothieMachine = (...ingredients) => {
  ...
  return function(...more){
    more = ingredients.concat(more)
    for(let i = 0; i < more.length; i++){
      if (i != 0 || count != 0){
        str = str.concat(' and ' + more[i])
      }
      else{
        str = str.concat(' ' + more[i])
      }
    }
    count ++
    return str
...
// prints "I'm having a smoothie with milk and kale and spinach"
console.log(smoothie1("honey", "pears", "berries"));
// prints "I'm having a smoothie with milk and kale and spinach and honey and pears and berries"let smoothie1 = smoothieMachine();
